 ...
 *If LV_USE_ASSERT_NULL is enabled then 'assert(ptr != NULL)' will run.
 *Will halt the system if failed.*/
...
/*Montserrat fonts with various styles and sizes have a good coverage of the symbols.
 *If you want to use your own font you can just comment out them and use `LV_FONT_CUSTOM`.*/
...
#if LV_USE_LABEL
    /*1: Enable selecting text*/
    #define LV_LABEL_TEXT_SELECTION 0
    /*1: Store extra some info in labels (12 bytes) to speed up drawing of very long texts*/
